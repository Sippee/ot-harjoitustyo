...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_suomaukkaasti_ei_vie_saldoa_negatiiviseksi(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_maukkaasti()
    ...
    def test_kortilla_ostaa_edullisesti_juuri_riittavasti(self):
        self.kortti = Maksukortti(2.5)
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_kortilla_ostaa_maukkaasti_juuri_riittavasti(self):
